...
describe('v1.SecretManagerServiceClient', () => {
    ...
    describe('createSecret', () => {
        it('invokes createSecret without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateSecretRequest', ['parent']);
    ...
    describe('addSecretVersion', () => {
        it('invokes addSecretVersion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AddSecretVersionRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getSecret', () => {
        it('invokes getSecret without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetSecretRequest', ['name']);
    ...
    describe('updateSecret', () => {
        it('invokes updateSecret without error', async () => {
            ...
            request.secret ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateSecretRequest', ['secret', 'name']);
    ...
    describe('deleteSecret', () => {
        it('invokes deleteSecret without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteSecretRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getSecretVersion', () => {
        it('invokes getSecretVersion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetSecretVersionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.secretmanager.v1.SecretVersion()
    ...
    describe('accessSecretVersion', () => {
        it('invokes accessSecretVersion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AccessSecretVersionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('disableSecretVersion', () => {
        it('invokes disableSecretVersion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DisableSecretVersionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.secretmanager.v1.SecretVersion()
    ...
    describe('enableSecretVersion', () => {
        it('invokes enableSecretVersion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('EnableSecretVersionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.secretmanager.v1.SecretVersion()
    ...
    describe('destroySecretVersion', () => {
        it('invokes destroySecretVersion without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DestroySecretVersionRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.secretmanager.v1.SecretVersion()
    ...
    describe('listSecrets', () => {
        it('invokes listSecrets without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListSecretsRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listSecretVersions', () => {
        it('invokes listSecretVersions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListSecretVersionsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
